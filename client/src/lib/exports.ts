...
export function exportSalesToPdf(sales: Array<{ invoiceNo: string; customerName?: string | null; sellerCode?: string | null; sellerName?: string | null; subtotal: string; paidAmount: string; status: string; createdAt: Date | string | number }>, filename = "مبيعات-معرض-حور.pdf") { return exportTableToPdf("تقرير فواتير المبيعات", mapSalesForExport(sales), filename); }
