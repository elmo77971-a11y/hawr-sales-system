...
function ModulePage({ module, label, summary, firstProduct, products, onBack }: { module: NavKey; label: string; summary?: { sales: number; profit: number; stockValue: number; installmentsDue: number } | null; firstProduct?: { id: number; salePrice: string }; products: { id: number; name: string; sku: string; barcode?: string | null; salePrice: string; stockQty: number }[]; onBack: () => void }) {
  ...
  const reportRows: ReportRow[] = summary ? [{ البيان: "إجمالي المبيعات", القيمة: `${summary.sales.toLocaleString("ar-EG")} ج.م`, الملاحظات: "من قاعدة البيانات" }, { البيان: "صافي الربح", القيمة: `${summary.profit.toLocaleString("ar-EG")} ج.م`, الملاحظات: "بعد المصروفات" }, { البيان: "قيمة المخزون", القيمة: `${summary.stockValue.toLocaleString("ar-EG")} ج.م`, الملاحظات: "حسب تكلفة الشراء" }, { البيان: "أقساط مستحقة", القيمة: `${summary.installmentsDue.toLocaleString("ar-EG")} ج.م`, الملاحظات: "غير مسددة" }] : [{ البيان: "إجمالي المبيعات", القيمة: "٢٤٨,٦٥٠ ج.م", الملاحظات: "بيانات عرضية" }, { البيان: "صافي الربح", القيمة: "٦٢,٤٢٠ ج.م", الملاحظات: "بيانات عرضية" }];
  const save = () => {
