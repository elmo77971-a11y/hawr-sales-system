...
Var HGInstallMode
Var HGInstallModeClean
Var HGInstallModeUpdate
...
Function InstallModePageCreate
  ...
  Pop $HGInstallModeUpdate
  ${NSD_CreateRadioButton} 10u 65u 90% 18u "تثبيت نظيف والبدء كأنه أول تشغيل"
  Pop $HGInstallModeClean
  ${NSD_SetState} $HGInstallModeUpdate ${BST_CHECKED}
  nsDialogs::Show
FunctionEnd

Function InstallModePageLeave
  ${NSD_GetState} $HGInstallModeClean $0
  ${If} $0 == ${BST_CHECKED}
    ...
    StrCpy $HGInstallMode clean
  ${Else}
    StrCpy $HGInstallMode update
  ${EndIf}
FunctionEnd
...
!macro customInstall
  ...
  StrCmp $HGInstallMode clean 0 keepData
