...
export async function createEmployee(input: { name: string; email?: string; employeeCode: string; password: string; salary?: string; role?: "user" | "admin" }) {
