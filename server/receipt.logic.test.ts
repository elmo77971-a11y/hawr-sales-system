...
describe("receipt printer", () => {
  it("builds an Arabic 80mm receipt containing invoice lines and totals", () => {
    const html = buildReceiptHtml({ invoiceNo: "S-100", mode: "sale", lines: [{ name: "خلاط", quantity: 2, unitPrice: "100", discount: 10 }], total: 190, paid: 100, customerName: "أحمد", sellerCode: "S-7", createdAt: "2026-08-26T12:00:00.000Z" });
