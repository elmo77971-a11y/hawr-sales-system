...
export function validateTransferLocations(fromLocation: string, toLocation: string) { if (!fromLocation.trim() || !toLocation.trim() || fromLocation === toLocation) throw new Error("Transfer locations must be different"); return true; }
